...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	private void addTab(int index, CharSequence text, int iconResId) {
		...
		if (iconResId != 0) {
			...
			// 0);
			tabView.setIconDrawableResId(iconResId);
		}
	...
	private class TabView extends TextView {
		...
		public TabView(Context context, AttributeSet attrs, int defStyleAttr) {
			...
			TypedArray a = context.obtainStyledAttributes(attrs,
					R.styleable.TabPageIndicatorStyle, defStyleAttr, 0);

			mIconLocation = a.getInt(
					R.styleable.TabPageIndicatorStyle_iconLocation, 1);
		 ...
		 * @param resId
		 */
		public void setIconDrawableResId(int resId) {
			switch (mIconLocation) {
			case 0: // left
